...
<head>
  ...
  <title>Acknowledgement Slip|Covid-19 Di9rectory for Vaccination</title>
...
<div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    ...
                    <div class="dragArea row"><span class="style1">
								<p>Dear <?php echo $_SESSION['fullname'] ;  ?>, Your Registration Was Successful	</p>				           
                    </span>
                      <p>&nbsp;</p>
					           <p>&nbsp;</p>
              </div>
			  					           <p class="style2"><strong>Vaccination ID</strong>: <?php echo $_SESSION['vaccinationID'] ;  ?></p>
			  					           <p class="style2"><strong>Vaccination Date</strong>: <?php echo $_SESSION['date'] ;  ?></p>
			  					           <p class="style2"><strong>Vaccination Slot</strong>: <?php echo $_SESSION['slot'] ;  ?></p>
			  					           <p class="style2"><strong>Vaccination Center</strong>: <?php echo $_SESSION['center'] ;  ?></p>
        </div>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
